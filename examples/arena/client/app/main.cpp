...
#include "arena_replica.h"  // synqtRegisterArenaReplicas()
#include "arena_consumer.h"  // synqtRegisterArenaConsumers()
#include "graphics.h"
...
int main(int argc, char *argv[])
{
    ...
    synqtRegisterArenaReplicas();
    synqtRegisterArenaConsumers();
    ...
    engine.loadFromModule("Arena", "Main");
