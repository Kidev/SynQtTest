...
#include "topology.h"
#include "scores_consumer.h"  // synqtRegisterScoresConsumers()
...
int main(int argc, char *argv[])
{
    ...
    qmlRegisterSingletonType(QUrl::fromLocalFile(
        qmlDir + QStringLiteral("/web/edge/World.qml")), "SynQt", 1, 0, "World");
    ...
    edge.setContextObject(EntityRuntime::accessorName(QStringLiteral("records")),
                          runtime.accessor(EntityRuntime::accessorName(QStringLiteral("records"))));
    if (!edge.start()) {
