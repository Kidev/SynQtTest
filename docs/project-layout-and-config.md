...
| `.synqt/design.json` | where the [visual editor](designer.md) last left each entity on its canvas |
...
holds an x and a y per entity, which is where the [visual editor](designer.md) left that
