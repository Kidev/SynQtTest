...
- You give each connect point an owner, which is also its name, a consumer allowlist,
  and (for browser consumers) a scope. The framework wires the links and authenticates
  them.
