...
//
// The alternative -- a custom server with `ws` bolted onto it -- is deliberately not a
...
// reasons, and the second is the load-bearing one: the App Router gives each route its own
